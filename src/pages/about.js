...
function about() {
  return (
    <div>
      ...
      <TransitionEffect />
      <main className="flex w-full h-full  flex-col items-center justify-center dark:text-light">
        <Layout className="pt-16">
          ...
          <div className="grid grid-cols-8 w-full gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:first-letter:order-2 md:col-span-8">
            ...
            <div className="col-span-2 flex flex-col items-center justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3">
              ...
              <div className="flex flex-col items-end justify-center xl:items-center">
                ...
                <h2 className="ext-xl font-medium capitalize text-dark/75 dark:text-light xl:text-center md:text-lg sm:text-base xs:text-sm">
                  project completed
                </h2>
              </div>

              <div className="flex flex-col items-end justify-center  r">
                <span className="inline-block text-7xl font-bold md:text-6xl sm:text-5xl xs:text-4xl">
                  <AnimatedNumbers value={2} />+
                </span>
                <h2 className="ext-xl font-medium capitalize text-dark/75 dark:text-light xl:text-center md:text-lg sm:text-base xs:text-sm">
                  yeqrs of exeperience
                </h2>
              </div>
            </div>
          </div>
